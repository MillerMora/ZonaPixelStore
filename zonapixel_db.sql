...
INSERT INTO marcas (nombre, logo_url) VALUES
  ('Larian Studios',       NULL),
  ('Nintendo',             NULL),
  ('Insomniac Games',      NULL),
  ('Remedy Entertainment', NULL),
  ('Capcom',               NULL),
  ('HyperX',               NULL),
  ('Logitech',             NULL),
  ('SteelSeries',          NULL),
...
-- Columnas: categoria_id, marca_id, nombre, descripcion, precio, precio_original, stock, imagen_principal, destacado
INSERT INTO productos (categoria_id, marca_id, nombre, descripcion, precio, precio_original, stock, imagen_principal, destacado) VALUES
(1, 1, 'Baldur''s Gate 3',
...
(2, 6, 'HyperX Alloy Origins Core TKL',
    'Construcción en aluminio CNC de grado aeroespacial, switches HyperX Red lineales, iluminación RGB por tecla y diseño TKL sin teclado numérico para mayor espacio en el escritorio.',
...
(2, 7, 'Logitech G Pro X Superlight 2',
    'Diseñado con los mejores esports players del mundo. Pesa menos de 60g, sensor HERO 2, conectividad LIGHTSPEED 2.4GHz con hasta 95h de batería y pies de PTFE de grado 1.',
...
INSERT INTO resenas (producto_id, autor_id, titulo, contenido, calificacion, imagen_portada, publicada, publicada_en) VALUES
(2, 2,
