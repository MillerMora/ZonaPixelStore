      ...
      <div class="dashboard-main">
        ...
        <div class="dash-topbar">
          ...
          <div class="dash-topbar-actions">
            ...
            <a href="../index.html" class="nav-icon-btn" title="Ver tienda"
        ...
        <div class="dash-content" id="dashContent">
          ...
          <div class="dash-stats-grid">
            ...
            <div class="dash-stat-card">
              ...
              <div class="dash-stat-value">$24.7M</div>
              <div class="dash-stat-label">Ingresos (COP)</div>
              <div class="dash-stat-change change-up">
            ...
            <div class="dash-stat-card">
              ...
              <div class="dash-stat-value">3,540</div>
              <div class="dash-stat-label">Usuarios registrados</div>
              <div class="dash-stat-change change-up">
            ...
            <div class="dash-card">
              ...
              <div class="dash-scroll-x">
                <table class="dash-table">
                  ...
                  <tbody>
                    <tr>
                      <td class="dash-td-muted">#10041</td>
                      <td>
                        <div class="dash-row-user gap-8">
                          <div class="user-row-avatar">CR</div>
                          Carlos R.
                        </div>
                      </td>
                      <td><span class="dash-tag tag-game">BG3</span></td>
                      <td class="dash-td-accent-strong">
                        $189.900
                      </td>
                      <td>
                        <span class="dash-status status-completed"
                          >Completado</span
                        >
                      </td>
                    </tr>
                    <tr>
                      <td class="dash-td-muted">#10040</td>
                      <td>
                        <div class="dash-row-user gap-8">
                          <div class="user-row-avatar">LM</div>
                          Laura M.
                        </div>
                      </td>
                      <td>
                        <span class="dash-tag tag-periph">Mouse Logitech</span>
                      </td>
                      <td class="dash-td-accent-strong">
                        $359.900
                      </td>
                      <td>
                        <span class="dash-status status-pending"
                          >Pendiente</span
                        >
                      </td>
                    </tr>
                    <tr>
                      <td class="dash-td-muted">#10039</td>
                      <td>
                        <div class="dash-row-user gap-8">
                          <div class="user-row-avatar">JP</div>
                          Juan P.
                        </div>
                      </td>
                      <td><span class="dash-tag tag-game">Zelda TotK</span></td>
                      <td class="dash-td-accent-strong">
                        $219.900
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="dash-td-muted">#10038</td>
                      <td>
                        <div class="dash-row-user gap-8">
                          <div class="user-row-avatar">AD</div>
                          Ana D.
                        </div>
                      </td>
                      <td>
                        <span class="dash-tag tag-periph">Teclado HyperX</span>
                      </td>
                      <td class="dash-td-accent-strong">
                        $289.900
                      </td>
                      <td>
                        <span class="dash-status status-cancelled"
                          >Cancelado</span
                        >
                      </td>
                    </tr>
                    <tr>
                      <td class="dash-td-muted">#10037</td>
                      <td>
                        <div class="dash-row-user gap-8">
                          <div class="user-row-avatar">MK</div>
                          Marta K.
                        </div>
                      </td>
                      <td>
                        <span class="dash-tag tag-game">Spider-Man 2</span>
                      </td>
                      <td class="dash-td-accent-strong">
                        $179.900
                      </td>
            ...
            <div class="dash-card">
              ...
              <div class="dash-list-col gap-12">
                <div class="dash-row-user gap-12">
                  <img
                    src="https://image.api.playstation.com/vulcan/ap/rnd/202302/2321/ba706e54d68d10a0eb6ab7c36cdad9178c58b7fb7bb03d28.png"
                ...
                <div class="dash-row-user gap-12">
                  <img
                    src="https://images.unsplash.com/photo-1596443686812-2f45229eebc3?w=500&q=80"
                    class="dash-top-product-img"
                    alt=""
                  />
                  <div class="dash-flex-1-min0">
                ...
                <div class="dash-row-user gap-12">
                  <img
                    src="https://images.unsplash.com/photo-1527814050087-3793815479db?w=500&q=80"
                    class="dash-top-product-img"
                    alt=""
                  />
                  <div class="dash-flex-1-min0">
                    <div class="dash-top-product-name">
                      HyperX Alloy Origins TKL
                    </div>
                    <div class="dash-top-product-meta">
                      118 unidades
                    </div>
              ...
              <table class="dash-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="dash-td-muted">carlos@mail.com</td>
                    <td class="dash-td-muted">12 ene 2025</td>
                    <td>8</td>
                    <td>
                      <span class="dash-status status-completed">Activo</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="dash-row-user gap-10">
                        <div class="user-row-avatar">LG</div>
                        <strong>Laura_G</strong>
                      </div>
                    </td>
                    <td class="dash-td-muted">laura@mail.com</td>
                    <td class="dash-td-muted">28 ene 2025</td>
                    <td>3</td>
                    <td>
                      <span class="dash-status status-completed">Activo</span>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div class="dash-row-user gap-10">
                        <div class="user-row-avatar">PM</div>
                        <strong>PixelMaster</strong>
                      </div>
                    </td>
                    <td class="dash-td-muted">pixel@mail.com</td>
                    <td class="dash-td-muted">5 feb 2025</td>
                    <td>12</td>
                    <td>
                      <span class="dash-status status-completed">Activo</span>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div class="dash-row-user gap-10">
                        <div class="user-row-avatar">AD</div>
                        <strong>AnaDev</strong>
                      </div>
                    </td>
                    <td class="dash-td-muted">ana@mail.com</td>
                    <td class="dash-td-muted">14 feb 2025</td>
                    <td>1</td>
                    <td>
                      <span class="dash-status status-pending">Inactivo</span>
                    </td>
                  </tr>
                </tbody>
              </table>
